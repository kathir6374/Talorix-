...
export default function InterviewSimPage({ params }: Props) {
    ...
    const questionsMap: Record<string, string[]> = {
        "frontend": [
            ...
            "How do you handle unit testing in frontend applications?",
            "How do you approach responsive design for multiple screen sizes?",
        ...
        "data science": [
            "Explain your approach to cleaning and preprocessing messy datasets.",
            "What is the difference between supervised and unsupervised learning?",
            "How do you choose the right machine learning model for a problem?",
            "Explain overfitting and how you prevent it.",
            "Walk us through a data project from collection to insight.",
        ...
        "data analyst": [
            ...
            "Explain a time you discovered an important insight from data.",
            "What SQL techniques do you use most often for analysis?",
            "How do you ensure data accuracy in your reports?",
            "Describe your experience with A/B testing.",
            "How do you handle missing or incomplete data?",
            "What KPIs would you track for a SaaS product?",
            "How do you prioritize which data questions to answer first?",
            "Explain the difference between correlation and causation with an example.",
            "How do you present data findings that challenge existing assumptions?"
        ],
        "machine learning": [
            ...
            "Describe a machine learning project that did not go as planned.",
            "How do you monitor model performance after deployment?"
        ],
        "ai": [
            "How do you evaluate the quality of AI-generated outputs?",
            "Explain the concept of prompt engineering.",
            "What ethical considerations arise when building AI products?",
            "How do you handle hallucinations in language models?",
            "Describe your experience with fine-tuning or RAG systems.",
            "How do you approach building responsible AI systems?",
            "What is the role of embeddings in modern AI applications?",
            "How do you handle AI model versioning and rollback?",
            "Explain the difference between zero-shot and few-shot learning.",
            "How do you measure the business impact of an AI feature?"
        ],
        "mobile": [
            "How do you approach building a cross-platform mobile app?",
            "Explain the differences between native and hybrid development.",
            "How do you optimize mobile app performance and battery usage?",
            "Describe your approach to handling offline functionality.",
            "How do you implement push notifications effectively?",
            "What is your strategy for mobile app testing across devices?",
            "How do you handle navigation patterns in complex mobile apps?",
            "Describe your experience with app store deployment and review.",
            "How do you manage state in a React Native or Flutter application?",
            "What accessibility considerations are unique to mobile apps?"
        ],
        "design": [
            "Walk us through your design process from brief to final delivery.",
            "How do you conduct and apply user research in your designs?",
            "Explain how you balance business goals with user needs.",
            "Describe a time you had to iterate based on user feedback.",
            ...
            "Explain how you measure the success of a design solution.",
            "Describe your experience with prototyping and usability testing.",
        ...
        "product manager": [
            ...
            "Describe a product you shipped from idea to launch.",
            ...
            "How do you decide when to pivot or persevere with a feature?",
            "Describe how you run an A/B test for a product change.",
            "How do you communicate product decisions to different stakeholders?",
            "What is your framework for making trade-off decisions?"
        ],
        "project manager": [
            ...
            "What tools and methodologies do you use for project tracking?",
            "How do you manage stakeholder expectations effectively?",
            "Describe a time you had to manage competing priorities across teams.",
            "How do you ensure quality deliverables under tight deadlines?",
            "What is your approach to resource allocation and capacity planning?",
            "How do you handle conflict within your project team?",
            "Describe your experience with Agile vs Waterfall methodologies."
        ],
        "qa": [
            "Describe your approach to creating a comprehensive test strategy.",
            "How do you decide between automated and manual testing?",
            "What is your process for reporting and tracking bugs?",
            "Explain how you approach regression testing after a major release.",
            "How do you ensure test coverage for critical business flows?",
            "Describe your experience with performance and load testing.",
            "How do you collaborate with developers to improve code quality?",
            "What testing frameworks have you worked with and why?",
            "How do you handle flaky tests in your CI pipeline?",
            "Explain your approach to API testing and contract testing."
        ],
        "security": [
            "How do you conduct a security assessment for a web application?",
            "Explain the OWASP Top 10 and which vulnerabilities you see most often.",
            ...
            "What is your approach to security in a CI/CD pipeline?",
            ...
            "Describe your experience with compliance frameworks like SOC 2 or ISO 27001."
        ],
        "cloud": [
            "How do you architect a highly available cloud solution?",
            "Describe your experience with serverless computing.",
            "How do you optimize cloud costs without compromising performance?",
            "Explain your approach to cloud security and IAM.",
            "How do you handle data migration to the cloud?",
            "What is your strategy for multi-region deployment?",
            "Describe your experience with auto-scaling and load balancing.",
            "How do you choose between different cloud services for a workload?",
            "What monitoring and observability tools do you use in the cloud?",
            "How do you handle disaster recovery in cloud infrastructure?"
        ],
        "marketing": [
            "How do you develop a go-to-market strategy for a new product?",
            "Describe your approach to measuring marketing ROI.",
            "How do you build and execute content marketing campaigns?",
            "What is your strategy for growing organic traffic?",
            "How do you segment and target your audience effectively?",
            "Describe a successful campaign you led and what made it work.",
            "How do you approach social media marketing for B2B vs B2C?",
            "What tools do you use for marketing analytics and reporting?",
            "How do you handle marketing budget allocation across channels?",
            "Describe your experience with email marketing automation."
        ],
        "sales": [
            ...
            "What CRM tools have you used and how do they improve your workflow?",
            "How do you build and maintain long-term client relationships?",
            "Describe a time you closed a difficult deal and what strategy worked.",
            "How do you forecast revenue and track pipeline health?",
            "What is your approach to negotiation and pricing discussions?",
            "How do you collaborate with marketing and product teams?",
            "Describe how you handle losing a deal to a competitor."
        ],
        "hr": [
            "How do you approach building a strong employer brand?",
            "Describe your experience with performance management systems.",
            "How do you handle employee conflict resolution?",
            "What is your approach to diversity, equity, and inclusion initiatives?",
            "How do you design effective onboarding programs?",
            "Describe your experience with compensation and benefits planning.",
            "How do you measure employee engagement and satisfaction?",
            "What compliance challenges have you navigated?",
            "How do you handle remote and hybrid workforce management?",
            "Describe a retention strategy that was particularly effective."
        ],
        "finance": [
            ...
            "What is your approach to managing cash flow?",
            "Explain how you analyze the financial health of a business.",
            "Describe your experience with audit preparation.",
            "How do you evaluate investment opportunities?",
            "What financial KPIs do you track most closely and why?",
            "How do you handle regulatory compliance in financial reporting?",
            "Describe a financial challenge you solved and the impact it had."
        ],
        "general": [
            ...
            "What is your preferred project management methodology?",
        ...
        const fetchJob = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    const initRes = await fetch("/api/interview-sim/init", {
                        method: "POST",
                    ...
                    if (initRes.ok) {
                        ...
                        if (!initData.allowed) {
                            setEligibilityError(initData.reason);
                            setLoading(false);
                            return;
                        }
                    } else {
                        const initErr = await initRes.json().catch(() => ({}));
                        setEligibilityError(initErr.error || "Failed to verify eligibility.");
                        setLoading(false);
                        return;
                    }

                    const title = data.job.job_title.toLowerCase();

                    // Check if employer provided custom AI questions
                    const customQuestions = data.job.ai_interview_questions || [];
                    const neededSlots = 10 - customQuestions.length;

                    // Collect questions from matching categories to backfill if needed
                    const matchedQuestions: Set<string> = new Set();
                    if (neededSlots > 0) {
                        for (const [key, qs] of Object.entries(questionsMap)) {
                            if (title.includes(key)) {
                                qs.forEach(q => matchedQuestions.add(q));
                            }
                        }

                        // Fallback to general if no match
                        if (matchedQuestions.size === 0) {
                            questionsMap["general"].forEach(q => matchedQuestions.add(q));
                        }
                    }

                    // Pick enough to fill the slots
                    const allMatched = Array.from(matchedQuestions);
                    const shuffledMatched = allMatched.sort(() => 0.5 - Math.random()).slice(0, neededSlots);

                    // Combine custom questions with backfilled questions
                    setQuestions([...customQuestions, ...shuffledMatched]);
                    setShowRules(true);
                }
            } catch (err) {
        ...
        return startInterviewProctoring(videoRef.current, {
            ...
            onTerminate: (message) => {
                ...
                fetch("/api/interview-sim/score", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ jobId, transcript: finalTranscript }),
                }).catch((err) => console.error("Termination scoring error:", err));
            },
        });
    }, [stream, showRules, result, terminationMessage, jobId]);
    ...
    }, [isProcessing, result, questions.length, currentQuestionIndex, mediaRecorder, allTranscripts, jobId, router, showRules, eligibilityError]);


    const confirmEndTestEarly = async () => {
                ...
                <div className="max-w-xl w-full bg-zinc-900/90 border border-white/20 rounded-3xl p-8 relative overflow-hidden backdrop-blur-md shadow-2xl shadow-black/40">
                    ...
                    <ul className="space-y-4 mb-10 relative z-10 text-sm">
                        ...
                        <li className="flex items-start gap-4 p-3 rounded-xl bg-white/10 border border-white/20">
                            ...
                            <span className="text-white/80 mt-1 font-medium leading-relaxed">For a single application, you are allowed a maximum of <strong>4 attempts</strong>.</span>
                        </li>
                    </ul>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <div className="flex justify-between items-center mt-2">
                        <p className="text-white/60">Practice your response for the <span className="text-white font-bold">{job?.job_title}</span> role.</p>
                            ...
                            <>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center p-8 md:p-16">
                                    <div className="text-center max-w-2xl">
                                        <div className="inline-flex items-center gap-2 bg-[#F59E0B]/10 border border-[#F59E0B]/30 px-4 py-1.5 rounded-full mb-6">
                                        ...
                                        <h2 className="text-white font-bold text-xl md:text-2xl lg:text-3xl leading-snug drop-shadow-sm">
                                            {questions[currentQuestionIndex]}
                                        </h2>
                                    </div>
                                </div>

                                {/* PiP video box (bottom-right, like a video call) */}
                                <div className="absolute bottom-4 right-4 w-36 h-28 sm:w-48 sm:h-36 rounded-2xl overflow-hidden border-2 border-white/20 shadow-2xl shadow-black/50 bg-black z-10">
                                    <video ref={videoRef} autoPlay muted playsInline className="w-full h-full object-cover scale-x-[-1]" />
                                    {proctorHighlight && (
                                        <div className="absolute inset-0 pointer-events-none scale-x-[-1]">
                                            <div
                                                className="absolute border-4 border-red-400/90 rounded-full shadow-[0_0_24px_rgba(248,113,113,0.75)] animate-pulse"
                                                style={{
                                    ...
                                    <div className="absolute top-2 left-2 flex items-center gap-1.5 bg-black/70 backdrop-blur-md px-2 py-1 rounded-full">
                        ...
                        {answerEvaluation ? (
                            <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4">
                                <button
                                    ...
                                    className="w-full sm:w-auto bg-white/10 border border-white/10 text-white font-extrabold px-12 py-3 sm:py-4 rounded-2xl transition-all shadow-sm hover:bg-white/15 flex items-center justify-center gap-2 text-lg"
                                >
                            ...
                            <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4">
                                {allTranscripts.length > 0 && currentQuestionIndex > 0 && (
                                    <button
                                        onClick={() => setShowEndEarlyConfirm(true)}
                                        disabled={isProcessing}
                                        className="w-full sm:w-auto bg-transparent border-2 border-red-500/50 hover:bg-red-500/10 text-red-500 font-extrabold px-6 sm:px-8 py-3 sm:py-4 rounded-2xl transition-all flex items-center justify-center gap-2 text-sm sm:text-base order-2 sm:order-1"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto bg-[#F59E0B] disabled:opacity-50 text-black font-extrabold px-12 py-3 sm:py-4 rounded-2xl transition-all shadow-sm shadow-[#F59E0B]/20 flex items-center justify-center gap-2 text-lg order-1 sm:order-2"
                                >
                            ...
                            <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4">
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto bg-white/10 border border-white/10 disabled:opacity-50 text-white font-extrabold px-12 py-3 sm:py-4 rounded-2xl transition-all shadow-sm hover:bg-white/15 flex items-center justify-center gap-2 text-lg order-1 sm:order-2"
                                >
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2" /></svg>
                ...
                {showEndEarlyConfirm && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            animate={{ scale: 1, opacity: 1, y: 0 }}
                            exit={{ scale: 0.9, opacity: 0, y: 20 }}
                            className="bg-zinc-950/95 border border-white/10 rounded-3xl p-8 max-w-sm w-full relative z-10 shadow-2xl shadow-black/60 text-center"
                        >
                            <div className="w-16 h-16 bg-red-500/10 border border-red-500/30 rounded-full flex items-center justify-center mx-auto mb-6">
                                <svg className="w-8 h-8 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h2 className="text-2xl font-bold text-white mb-2">End Test Early?</h2>
                            <p className="text-white/70 mb-8 max-w-[280px] mx-auto leading-relaxed text-sm">
                                Are you sure you want to end the test early and evaluate your current answers?
                            </p>
                            <div className="flex gap-4">
                                <button
                                    onClick={() => setShowEndEarlyConfirm(false)}
                                    className="flex-1 bg-white/5 hover:bg-white/10 text-white border border-white/10 font-bold py-3.5 rounded-xl transition-all"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={confirmEndTestEarly}
                                    className="flex-1 bg-red-500 hover:bg-red-600 text-white font-extrabold py-3.5 rounded-xl transition-all shadow-xl shadow-red-500/20"
                                >
                                    End Test
                                </button>
                            </div>
